...
sns.lineplot(x='Traverse',y='Kraft',data=dataset2,label='[0/90/45/-45] Sample', color='blue')
...
sns.lineplot(x='Strain',y='Stress',data=dataset2,label='[0/90/45/-45] Sample', color='blue')
